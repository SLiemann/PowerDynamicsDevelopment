...
NodeType(L::Union{GridFormingConverter,GridFormingConverterParam,GridFormingConverterCSA})  = 1
...
PowerNodeLoad(L::Union{GridFormingConverter,GridFormingConverterParam,GridFormingConverterCSA},U)  = 0. #treated as generation
...
PowerNodeGeneration(L::Union{GridFormingConverter,GridFormingConverterParam,GridFormingConverterCSA})  = L.p0set #treated as generation
