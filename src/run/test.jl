...
begin
    ...
    buses=OrderedDict(
        ...
        "bus2"=> VoltageDependentLoad(P=-0.3, Q=+0.5, U=1.0, A=0., B=0.,Y_n = complex(0.0)))

    branches=OrderedDict(
        "branch3"=> DynamicPowerTransformer(from="bus1",to="bus2",Sbase=Sbase,Srated=100e6,uk=0.1581138,XR_ratio=3, i0=6.35,Pv0=300e3,
...
function calcOLTC(pg,ic)
    ...
    sol = solve(prob, Rodas4(), callback = CallbackSet(cb1,cb2,cb3), dtmax = 1e-4)
