...
begin
    ...
    prob = ODEProblem(rhs(pg1),ic,(0.0,1.0),[], initializealg = BrownFullBasicInit())
    sol = solve(prob, Rodas4(),dtmax = 1e-4,progress=true) #tstops= tstep,callback = CallbackSet(cb,cb1)
